...
public class Main {
    ...
    public static void runExercise1() {
        ...
        students.forEach(
                student -> System.out.println(student.getLastName().toUpperCase())
        );
    ...
    public static void runExercise2() {
        ...
        List<Student>  filterGender = students.stream()
                .filter(
                        student -> "MALE".equals(student.getGender().toString())
